...
const CategoryLeft = () => {
  return (
    <div className="col-12 bg-light p-2"  style={{ position: "absolute", right: "10px" ,color: "#072541"}}>
      <h5 className="p-3 border rounded bg-warning">Product Category</h5>
      <div
        className={`${Style.SideBar} d-flex d-lg-block d-md-flex d-sm-flex`}
        style={{ overflow: "scroll" }}
      >
        <div
          className={`col-lg-12 col-3 justify-content-lg-between justify-content-center d-flex mx- m-2 mx-lg-0 rounded bg-white
