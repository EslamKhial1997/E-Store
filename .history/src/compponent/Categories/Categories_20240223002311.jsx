      ...
      <div className="container-fluid d-flex justify-content-around align-items-center flex-wrap">
        <div className="col-12 bg-light p-3">
          <div className="d-flex justify-content-between flex-wrap align-items-center">
            ...
            <div className="col-lg-8 col-12 d-flex align-items-center justify-content-lg-end justify-content-between bg-danger">
              <small className="col-4 bg-info">Category 1500 Result</small>
              <div className="col-7">
                {" "}
                <select
