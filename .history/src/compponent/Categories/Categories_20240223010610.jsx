  ...
  return (
    <div>
      ...
      <div className="container-fluid d-flex justify-content-around align-items-center flex-wrap">
        <div className="col-12  p-3" style={{ backgroundColor: "#072541" }}>
          <div className="d-flex justify-content-between flex-wrap align-items-center">
            <div className="col-lg-3 col-12 d-flex justify-content-between border rounded">
              <input
                type="text"
                placeholder="Search"
        ...
        <div className="d-flex col-12 justify-content-around flex-wrap ">
          {" "}
          <div className="col-lg-2 col-12 col-12 bg-light border rounded">
            {" "}
            <CategoryLeft />
          </div>
