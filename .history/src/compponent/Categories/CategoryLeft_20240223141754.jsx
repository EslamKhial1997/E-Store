...
const CategoryLeft = () => {
  return (
    <div className="col-12 bg-light p-2 border rounded" >
      ...
      >
        <div
          className={`col-lg-12 col-3 justify-content-lg-between justify-content-center d-flex mx-lg-0 m-2 mx-2 rounded bg-white
       border border-bottom  shadow-lg ${Style.Popular}`}
        ...
        <div
          className={`col-lg-12 col-3 justify-content-between d-flex mx-lg-0 m-2 mx-2 rounded bg-white
       border border-bottom  shadow-lg ${Style.Popular}`}
        >
          <div
            className=" justify-content-lg-between align-items-center justify-content-center d-flex flex-wrap p-2 text-center rounded "
