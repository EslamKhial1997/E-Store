...
const CategoryLeft = () => {
  return (
    <div className="col-12 bg-light p-2 border rounded" >
      <h5 className="p-3 border rounded "  style={{ backgroundColor: "#FFBB5C" , color:"#072541"}}>Product Category</h5>
      <div
        className={`${Style.SideBar} d-flex d-lg-block d-md-flex d-sm-flex`}
        style={{ overflow: "scroll" }}
      >
        <div
          className={`col-lg-12 col-3 justify-content-lg-between justify-content-center d-flex m-lg-0 m-2 rounded bg-white
       border border-bottom  shadow-lg ${Style.Popular}`}
        ...
        <div
          className={`col-lg-12 col-3 justify-content-between d-flex m-lg-0 m-2 rounded bg-white
       border border-bottom  shadow-lg ${Style.Popular}`}
        >
          <div
            className=" justify-content-lg-between align-items-center justify-content-center d-flex flex-wrap p-2 text-center rounded "
       ...
       border border-bottom  shadow-lg ${Style.Popular}`}
        ...
        <div
          className={`col-lg-12 col-3 justify-content-between d-flex mx-lg-0 mx-2 m-lg-0 m-2 rounded bg-white
       border border-bottom  shadow-lg ${Style.Popular}`}
        >
          <div
            className=" justify-content-lg-between align-items-center justify-content-center d-flex flex-wrap p-2 text-center rounded "
