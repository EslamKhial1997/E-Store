...
const CategoryLeft = () => {
  return (
    <div className="col-12 bg-light">
      <h5 className="p-2">Product Category</h5>
      <div
        className={`d-flex flex-wrap justify-content-around text-dark ${Style.SideBar}`}
        style={{ overflow: "scroll" }}
      >
        <div
          className={`col-lg-12 col-3 justify-content-between text-center d-flex mx-1 m-2 mx-lg-0 rounded bg-white
