      ...
      <div className="container-fluid d-flex justify-content-around align-items-center flex-wrap">
        <div className="col-12 bg-light p-3">
          <div className="d-flex justify-content-between  align-items-center">
            <div className="col-lg-3 col-md-6 col-sm-6 d-flex justify-content-between border">
            ...
            <div className="col-lg-8 col-md-5 col-sm-5 d-flex align-items-center justify-content-lg-end justify-content-between bg-danger">
              <span className="col-lg-2 col-6">Category 1500 Result</span>
