  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        Cell: ({ cell }) => (
          // console.log(cell.row.original.addresses)
          <Swiper
            slidesPerView={1}
            spaceBetween={10}
            autoplay={{
          ...
          >
            {cell.row.original.coupons.length > 0
              ? cell.row.original.coupons.map((e, inx) => (
                  <SwiperSlide key={inx}>
                    <span className="d-block fw-bold" style={{fontSize:"12px" }}>{e.alias}</span>
                    <span className="d-block fw-bold" style={{fontSize:"12px" }}>{e.details}</span>
                    <span className="d-block fw-bold" style={{fontSize:"12px" }}>{e.phone}</span>
                    <span className="d-block fw-bold" style={{fontSize:"12px" }}>{e.city}</span>
                    <span className="d-block fw-bold" style={{fontSize:"12px" }}>{e.postalCode}</span>
                  </SwiperSlide>
                ))
              : "-  -  -  -  -  -  -  -"}
          </Swiper>
