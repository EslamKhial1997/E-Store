          ...
          >
            {cell.row.original.addresses.length > 0
              ? cell.row.original.addresses.map((e, inx) => (
                  <SwiperSlide key={inx}>
                    <span className="d-block fw-bolder" style={{fontSize:"10px" }}>{e.alias}</span>
                    <span className="d-block fw-bolder" style={{fontSize:"10px" }}>{e.details}</span>
                    <span className="d-block fw-bolder" style={{fontSize:"10px" }}>{e.phone}</span>
                    <span className="d-block fw-bolder" style={{fontSize:"10px" }}>{e.city}</span>
                    <span className="d-block fw-bolder" style={{fontSize:"10px" }}>{e.postalCode}</span>
                  </SwiperSlide>
                ))
              : "-  -  -  -  -  -  -  -"}
          </Swiper>
