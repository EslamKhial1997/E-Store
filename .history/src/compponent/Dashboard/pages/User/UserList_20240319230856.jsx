    ...
    () => [
      ...
      },
      {
        ...
        Cell: ({ cell }) => (
          ...
          //         <div key={inx}>
          //           <span style={{ maxHeight: "50px" }}>{e.alias}</span>
          //           <span style={{ maxHeight: "50px" }}>{e.details}</span>
          //           <span style={{ maxHeight: "50px" }}>{e.phone}</span>
          //           <span style={{ maxHeight: "50px" }}>{e.city}</span>
          //           <span style={{ maxHeight: "50px" }}>{e.postalCode}</span>
          //         </div>
          //       ))
          //     : ""}
          // </Swiper>
