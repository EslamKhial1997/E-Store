          ...
          >
            {cell.row.original.addresses.length > 0
              ? cell.row.original.addresses.map((e, inx) => (
                  <SwiperSlide key={inx}>
                    <span className="d-block" style={{fontSize }}>{e.alias}</span>
                    <span className="d-block" style={{fontSize }}>{e.details}</span>
                    <span className="d-block" style={{fontSize }}>{e.phone}</span>
                    <span className="d-block" style={{fontSize }}>{e.city}</span>
                    <span className="d-block" style={{fontSize }}>{e.postalCode}</span>
                  </SwiperSlide>
                ))
              : ""}
          </Swiper>
