          ...
          >
            {cell.row.original.addresses.length > 0
              ? cell.row.original.addresses.map((e, inx) => (
                  <SwiperSlide key={inx}>
                    <span className="d-block" style={{font }}>{e.alias}</span>
                    <span className="d-block" style={{font }}>{e.details}</span>
                    <span className="d-block" style={{font }}>{e.phone}</span>
                    <span className="d-block" style={{font }}>{e.city}</span>
                    <span className="d-block" style={{font }}>{e.postalCode}</span>
                  </SwiperSlide>
                ))
              : ""}
          </Swiper>
