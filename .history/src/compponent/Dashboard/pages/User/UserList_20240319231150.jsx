          ...
          >
            {cell.row.original.addresses.length > 0
              ? cell.row.original.addresses.map((e, inx) => (
                  <SwiperSlide key={inx}>
                    <span className="d-block" style={{ }}>{e.alias}</span>
                    <span className="d-block" style={{ }}>{e.details}</span>
                    <span className="d-block" style={{ }}>{e.phone}</span>
                    <span className="d-block" style={{ }}>{e.city}</span>
                    <span className="d-block" style={{ }}>{e.postalCode}</span>
                  </SwiperSlide>
                ))
              : ""}
          </Swiper>
