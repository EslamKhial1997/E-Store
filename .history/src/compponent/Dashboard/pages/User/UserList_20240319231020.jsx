          ...
          >
            {cell.row.original.addresses.length > 0
              ? cell.row.original.addresses.map((e, inx) => (
                  <SwiperSlide key={inx}>
                    <span className="d-block" style={{ maxHeight: "50px" }}>{e.alias}</span>
                    <span className="d-block" style={{ maxHeight: "50px" }}>{e.details}</span>
                    <span className="d-block" style={{ maxHeight: "50px" }}>{e.phone}</span>
                    <span className="d-block" style={{ maxHeight: "50px" }}>{e.city}</span>
                    <span className="d-block" style={{ maxHeight: "50px" }}>{e.postalCode}</span>
                  </SwiperSlide>
                ))
              : ""}
          </Swiper>
