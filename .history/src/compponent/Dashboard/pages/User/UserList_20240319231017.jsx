          ...
          >
            {cell.row.original.addresses.length > 0
              ? cell.row.original.addresses.map((e, inx) => (
                  <SwiperSlide key={inx}>
                    <span clas style={{ maxHeight: "50px" }}>{e.alias}</span>
                    <span clas style={{ maxHeight: "50px" }}>{e.details}</span>
                    <span clas style={{ maxHeight: "50px" }}>{e.phone}</span>
                    <span clas style={{ maxHeight: "50px" }}>{e.city}</span>
                    <span clas style={{ maxHeight: "50px" }}>{e.postalCode}</span>
                  </SwiperSlide>
                ))
              : ""}
          </Swiper>
