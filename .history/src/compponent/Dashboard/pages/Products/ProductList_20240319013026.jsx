  ...
  const columns = useMemo(
    () => [
...

      {
        ...
        Cell: ({ cell }) => (
          ...
          // console.log(cell.row.original.category.name)
          <span style={{ maxHeight: "50px" }}>
           { cell.row.original.category === null ?"-  -  -  -  -  -  -  -":cell.row.original.category.name}
          </span>
        ),
      },
      {
    ...
    >
      ...
      { cell.row.original.subCategory.length > 0
        ...
        >
          <MenuItem onClick={handleClose}>{ cell.row.original.category === null ?"-  -  -  -  -  -  -  -":cell.row.original.category.name}</MenuItem>
          ...
          //  { cell.row.original.category === null ?"-  -  -  -  -  -  -  -":cell.row.original.category.name}
          // </span>
        //   <span style={{ maxHeight: "50px" }} key={inx}>
        //  {e.name}
        //  </span>
        // console.log(e.name)
          ))
