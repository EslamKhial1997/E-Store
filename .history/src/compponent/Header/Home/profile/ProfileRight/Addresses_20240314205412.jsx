    ...
    <div className="container ">
      ...
      >
        <div className="d-flex  col-12 justify-content-between pt-2 ">
          ...
          <div className="">
            <EditIcon color="primary"/> <DeleteIcon color=""/>
          </div>
        </div>
        <div>
        <div>
       ...
       <div className="d-block"> <span className="fw-bold">Phone:</span><small>01098648010</small> </div>
       <div className="d-block"> <span className="fw-bold">Gander:</span><small>Male</small> </div>
       <div className="d-block"> <span className="fw-bold">postalCode:</span><small>068</small> </div>
