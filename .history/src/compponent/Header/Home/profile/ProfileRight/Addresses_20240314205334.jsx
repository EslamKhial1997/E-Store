  ...
  return (
    <div className="container ">
      ...
      >
       ...
       <div className="d-block"> <span className="fw-bold text-secoundry">Phone:</span><small>01098648010</small> </div>
       <div className="d-block"> <span className="fw-bold text-secoundry">Gander:</span><small>Male</small> </div>
       <div className="d-block"> <span className="fw-bold text-secoundry">postalCode:</span><small>068</small> </div>
