  ...
  return (
    <div className="container">
      ...
      <div className="d-flex justify-content-around flex-wrap">
        ...
        <div className="d-flex flex-wrap col-lg-3 col-6 bg-body border p-2 rounded">
          ...
          <div className="">
            ...
            <span className="d-block text-truncate" style={{ width: "10em" }}>
        ...
        <div className="d-flex col-lg-3 col-11 bg-body border p-2 rounded">
