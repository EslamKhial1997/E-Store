      ...
      <div className="d-flex justify-content-center align-items-center py-lg-5 py-2 mt-3 rounded bg-warning">
        <div className="container">
          ...
          <div className="d-flex">
            <div className="d-flex col-lg-8 col-12 justify-content-between">
              <div className="col-12 d-flex flex-wrap">
                <label className=" col-12 text-danger fw-bold">Delete Your Account</label>{" "}
                <span className=" col-12 text-danger fw-bold">We are sad to see you go, but hope to see you again!</span>{" "}
