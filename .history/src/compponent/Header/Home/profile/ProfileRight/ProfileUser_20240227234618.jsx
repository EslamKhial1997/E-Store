      ...
      <div>
        <form className="row g-3">
          <div className="col-md-6">
            ...
            <input type="email" className="form-control" id="inputEmail4" placeholder="Enter Your E-Mail"/>
          </div>
          ...
          <div className="col-md-6">
            ...
            <input type="text" className="form-control" id="inputCity" placeholder="Enter Your"/>
          </div>
          ...
          <div className="col-12">
            <button type="submit" className="btn text-light fw-bold" style={{ backgroundColor: "#072541" }}>
              Update Profile
            </button>
          </div>
        </form>
