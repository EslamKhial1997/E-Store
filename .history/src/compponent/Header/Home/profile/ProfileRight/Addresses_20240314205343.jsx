  ...
  return (
    <div className="container ">
      ...
      >
       ...
       <div className="d-block"> <span className="fw-bold text-secoundery">Phone:</span><small>01098648010</small> </div>
       <div className="d-block"> <span className="fw-bold text-secoundery">Gander:</span><small>Male</small> </div>
       <div className="d-block"> <span className="fw-bold text-secoundery">postalCode:</span><small>068</small> </div>
