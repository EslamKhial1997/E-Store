    ...
    <div className="container">
      ...
      <div className="d-flex justify-content-around flex-wrap">
        ...
        >
          <ListItemButton
            onClick={handleClick}
            className=" rounded text-light d-flex justify-content-around"
        ...
        <List
          ...
          aria-labelledby="nested-list-subheader"
        >
          <ListItemButton onClick={handleClick}   className=" rounded text-light d-flex justify-content-around"
          style={{ backgroundColor: "#072541" }}>
            <div className="d-flex align-items-center justify-content-between col-12">
              <PaymentsIcon
                color="warning"
        ...
        <List
          ...
          aria-labelledby="nested-list-subheader"
        >
          <ListItemButton onClick={handleClick}   className=" rounded text-light d-flex justify-content-around align-items-center"
          style={{ backgroundColor: "#072541" }}>
            <div className="d-flex align-items-center justify-content-between col-12">
              <LocalShippingIcon
                color="warning"
