...
import ShoppingCartNav from "../ShopCart/ShoppingCartNav";
    ...
    >
      <div className="container-fluid align-items-center ">
        ...
        >
          <NavLink
            to={"/"}
            className="navbar-brand col-2 text-light fs-3 fw-bolder mt-2 mt-lg-0 fst-italic"
          >
        ...
        <div className="d-flex col-lg-8 col-12 justify-content-between align-items-center">
          ...
          <div className="d-flex align-items-center">
            <div>
              <a className="text-reset me-3" href="#" onClick={()=>{setOpen(true)}}>
