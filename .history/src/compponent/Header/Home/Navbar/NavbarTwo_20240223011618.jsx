  ...
  return (
    ...
    >
      <div className="container-fluid">
        ...
        <div className="d-flex col-lg-8 justify-content-between align-items-center">
          {" "}
          <div
            className=" d-flex align-items-center col-6 mb-2 mb-lg-0 "
            style={{ position: "relative" }}
          >
            <input
              className="w-100 rounded border-warning p-2"
              placeholder="Search"
            />
            <Search
