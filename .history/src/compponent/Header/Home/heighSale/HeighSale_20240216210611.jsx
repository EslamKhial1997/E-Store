...
const HeighSale = () => {
  return (
    <div className="  p-3 bg-warning my-lg-5 my-md-3 my-sm-3 my-3">
      <div className="d-flex col-12 container-fluid d-flex justify-content-between align-items-center ">
        {" "}
        <strong className="border p-2 text-light rounded" style={{backgroundColor:"#072541"}}>Heigh Sales</strong>
        <div
