          ...
          <div className="row d-flex justify-content-center my-4">
            <div className={` col-md-4 h-100`}>
              <div className="card mb-4">
                ...
                <div className="container d-flex justify-content-between pt-2"><input type="text" placeholder="Enter Your Coupon" className="col-8 border rounded"/><button className="bg-warning border-0">Check Coupon</button></div>
