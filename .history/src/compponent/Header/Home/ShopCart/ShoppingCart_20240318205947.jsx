          ...
          <div className="row d-flex justify-content-center my-4">
            <div className={` col-md-4 h-100`}>
              <div className="card mb-4">
                ...
                <div className="container d-flex justify-content-center pt-2"><input type="text" placeholder="Enter Your Coupon" className="col-11 border rounded"/><button></button></div>
