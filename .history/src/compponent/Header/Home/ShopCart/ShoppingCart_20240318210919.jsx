            ...
            <div className={` col-md-4 h-100`}>
              <div className="card mb-4">
                ...
                <div className="container d-flex justify-content-between pt-2">
                  ...
                  />
                  <button className="bg-warning border-0 rounded text-light">
                    Check Coupon
                  </button>
                </div>
                <div className="card-body">
                  <ul className="list-group list-group-flush">
                    ...
                    <li className="list-group-item d-flex justify-content-between align-items-center border-0 px-0 mb-3">
                      <div>
                        <strong className="text-success">Total amount after discount</strong>
                      </div>
                      <span>
                        <strong className="text-success fw-bold">$50.98</strong>
                      </span>
                    </li>
