    ...
    <div>
      ...
      <div className="d-flex container justify-content-around mb-2 mt-5 flex-wrap">
        ...
        <div className="col-lg-6 col-md-4 col-sm-12 col-12 shadow-lg p-3 mb-5 bg-white rounded text-start">
          ...
          <small className="text-wrap text-truncate d-block" style={{overflowY:"scroll",maxHeight:"50px"}}>
          ...
          <div>
            ...
            <div>
              ...
              <div className="d-flex justify-content-around my-3">
                <Chip
                  label="xLarge"
                avatar={<Avatar className="text-light fw-bold" sx={{ bgcolor:"#072541"}}>X</Avatar>}
                  clickable
                  color="warning"
                  variant="elevated"
                />
                <Chip
                  label="Large"
                  avatar={<Avatar className="text-light fw-bold" sx={{ bgcolor:"#072541"}}>L</Avatar>}
                  clickable
                  color="warning"
                  variant="elevated"
                />
                <Chip
                  label="Medium"
                  avatar={<Avatar className="text-light fw-bold" sx={{ bgcolor:"#072541"}}>M</Avatar>}
                  clickable
                  color="warning"
                  variant="elevated"
                />
                <Chip
                  label="Small"
                  avatar={<Avatar className="text-light fw-bold" sx={{ bgcolor:"#072541"}}>S</Avatar>}
                  clickable
                  color="warning"
                  variant="elevated"
                />
