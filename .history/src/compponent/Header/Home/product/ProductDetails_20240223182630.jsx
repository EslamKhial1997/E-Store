        ...
        <div className="col-lg-6 col-md-4 col-sm-12 col-12 shadow-lg p-3 mb-5 bg-white rounded text-start">
          ...
          <div className="d-flex align-items-center justify-content-between">
            <div className="col-4 d-flex justify-content-around align-items-center">
              ...
              <button className="col-4 d-flex justify-content-around align-items-center text-dark p-23 rounded border-0 bg-warning fw-bolder text-light">
                <AddIcon fontSize="small" />
              </button>
            </div>
            <button
              className="btn text-light d-flex col-3 p-2 justify-content-around align-items-center"
              style={{ backgroundColor: "#072541", cursor: "pointer" }}
            >
              <span>Add To </span> <ShoppingCart />
            </button>
            <NavLink
              to="/shopCart"
