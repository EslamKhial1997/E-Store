...
const ProductDetailsRight = () => {
  return (
    <div className="col-lg-6 col-md-4 col-sm-12 col-12 shadow-lg p-3 mb-5 bg-white rounded text-start"  style={{ height: "65vh" , position:"relative" }}>
          <div>
          ...
          <div className="d-flex align-items-center justify-content-between w-100 p-3" style={{position:"absolute" , bottom:"0px" , left:"0"}}>
