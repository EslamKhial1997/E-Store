        ...
        <div className="col-lg-6 col-md-4 col-sm-12 col-12 shadow-lg p-3 mb-5 bg-white rounded text-start">
          ...
          <div className="d-flex align-items-center">
            <div className="col-4 d-flex justify-content-around align-items-center">
              <button className="col-4  text-dark p-1 rounded border-0 bg-warning fw-bolder text-light">
                <RemoveIcon fontSize="small" />
              </button>
              <button className="col-3 rounded border-0">5</button>
              <button className="col-4 d-flex justify-content-around align-items-center text-dark p-1 rounded border-0 bg-warning fw-bolder text-light">
                <AddIcon fontSize="small" />
              </button>
            </div>
            <NavLink
              to="/shopCart"
              className="btn text-light col-7"
