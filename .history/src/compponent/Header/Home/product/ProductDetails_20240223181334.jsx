    ...
    <div>
      ...
      <div className="d-flex container justify-content-around mb-2 mt-5 flex-wrap">
        ...
        <div className="col-lg-6 col-md-4 col-sm-12 col-12 shadow-lg p-3 mb-5 bg-white rounded text-start">
          ...
          <div className="d-flex align-items-center">
            <div className="col-4">
              <button className="btn bg-warning fw-bolder text-light">-</button>
              <button className="btn">5</button>
              <button className="btn bg-warning fw-bolder btn-small text-light"><AddIcon fontSize="small"/></button>
            </div>
            <NavLink
              to="/shopCart"
